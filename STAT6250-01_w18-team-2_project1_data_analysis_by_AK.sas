...
Possible Follow-up Steps: Tallying the total count for a neighbourhood with count by each factor will not be appropriate.Just use the factors combination that contributed more for a neighbourhood. Figure out how multiple factors could be analyzed.
;
proc freq 
